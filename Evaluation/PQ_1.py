...
if __name__ == "__main__":
    ...
    img_list = os.listdir('../SBHC/{}/images'.format(s))

    img_name = 'img73.png'

    pred = cv2.imread(os.path.join('../SBHC/{}/predicts_test'.format(s), img_name), cv2.IMREAD_UNCHANGED)
    ...
    # target = cv2.imread(os.path.join('../SBHC/{}/mBEST_predicts'.format(s), img_name), cv2.IMREAD_UNCHANGED)
